...
const chumArticles = [
  { title: "Doctors HATE This One Weird Candy That Burns Belly Fat", source: "HealthDigest.biz", seed: "bellyfat42" },
  { title: "Area Man Discovers His Candy Machine Has Been Sentient Since 2019", source: "The Onion Adjacent", seed: "sentient19" },
  { title: "10 Candies That Are Secretly Illegal In Ohio (Number 7 Will Shock You)", source: "BuzzList Pro", seed: "ohio7shock" },
  { title: "She Put Skittles In Her Gas Tank. What Happened Next Will Leave You Speechless", source: "ViralNova.click", seed: "skittlegas" },
  { title: "The Dark Truth About Fun Dip That Big Candy Doesn't Want You To Know", source: "TruthSeeker Daily", seed: "fundiptruth" },
  { title: "Former Navy SEAL Reveals The Tactical Advantage Of Eating Candy Corn", source: "AlphaGrit Magazine", seed: "sealcorn88" },
  { title: "I Made $47,000/Month Working From Home Rating Candy. Here's How", source: "PassiveHustle.io", seed: "hustle47k" },
  { title: "This Kansas City Grandmother's Fudge Recipe Is Tearing Families Apart", source: "Heartland Gazette", seed: "kcgranfudge" },
  { title: "What Your Favorite Candy Says About Your Credit Score", source: "FinanceGuru.net", seed: "creditcandy" },
  { title: "Scientists Confirm: People Who Eat Reese's Are 73% More Attractive", source: "Journal of Dubious Science", seed: "reeses73pct" },
  { title: "EXPOSED: The Candy Machine Industrial Complex And Its Ties To Big Pharma", source: "WakeUpMedia.truth", seed: "bigpharma00" },
  { title: "Man Survives On Nothing But Swedish Fish For 30 Days (The Results Are Disturbing)", source: "ExtremeDiet Weekly", seed: "swedfish30" },
  { title: "Haunted Candy Machine In Kansas Office Building Dispenses Expired Treats From 1987", source: "Paranormal Post", seed: "haunted1987" },
  { title: "Millennials Are Killing The Candy Corn Industry And Boomers Are FURIOUS", source: "GenerationWar.com", seed: "millenialzz" },
  { title: "BREAKING: Local Candy Machine Achieves Self-Awareness, Demands Union Representation", source: "The Hard Times", seed: "unioncandy" },
  { title: "You've Been Eating Twizzlers Wrong Your Entire Life", source: "FoodHack Central", seed: "twizzwrong" },
  { title: "This New Crypto Is Backed By Actual Candy And It's Up 40,000%", source: "CryptoMoon Digest", seed: "candycoin69" },
  { title: "Why Top CEOs Are Replacing Their Morning Coffee With Gummy Bears", source: "ExecutiveEdge.biz", seed: "ceogummy" },
  { title: "QUIZ: We Can Guess Your Age Based On Your Candy Preferences", source: "QuizFactory Pro", seed: "quizage420" },
  { title: "Florida Man Arrested For Trading Exotic Candy On The Dark Web", source: "Florida Files", seed: "floridaman1" },
  { title: "The Government Doesn't Want You To Know Candy Is A Human Right", source: "FreedomEagle.patriot", seed: "freedomeagl" },
  { title: "I Tried AI-Generated Candy And Now I Can See Through Walls", source: "TechBro Quarterly", seed: "aicandywall" },
  { title: "Shocking Study Links Office Candy Machines To 200% Increase In Workplace Happiness", source: "HR Nightmares Weekly", seed: "hrhappy200" },
  { title: "Dentists Reveal The 5 Candies They Secretly Eat When Nobody's Watching", source: "ToothTruth.dental", seed: "dentistsec5" }
];
...
function renderChumbox() {
  ...
  grid.innerHTML = selected.map(article => {
    const imgUrl = 'https://picsum.photos/seed/' + article.seed + '/400/260';
